...
SimFunction = Callable[[SimKwargs], Performance]

class OptimizationResult:
    def _init_(self, parameters: Parameters, performance: Performance):
...
class GridSearchOptimizer:
    def _init_(self, simulation_function: SimFunction):
    ...
    # Get the best results based on a specific metric
