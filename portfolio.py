...
from typing import List, Dict, Any, Set, NewType
...
class Position(object):
    ...
    shares.
    The _init_ method is equivalent to a buy operation. The exit
    method is a sell operation.
    """

    def _init_(self, symbol: Symbol, entry_date: pd.Timestamp,
